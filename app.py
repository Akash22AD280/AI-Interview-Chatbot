        ...
        return {
          "intro": {
            ...
            "intermediate": [
                ...
                "What technical communities or resources do you engage with?",
                "How do you adapt when project requirements suddenly change?"
            ],
            "advanced": [
                ...
                "How do you handle executive stakeholders with conflicting expectations?",
                "What is your philosophy on innovation vs. practicality in technology adoption?"
            ]
        },
        "projects": {
            "beginner": [
                ...
                "What role did you play in your team project?",
                "How did you manage your time across different tasks in the project?"
            ],
            "intermediate": [
                ...
                "How did you collaborate with other teams during your project?",
                "What trade-offs did you make in your project design?"
            ],
            "advanced": [
                ...
                "What strategies do you use for monitoring and observability?",
                "How do you manage technical risks in project planning?"
            ]
        },
        "skills": {
            "beginner": [
                ...
                "Which tools or IDEs do you prefer and why?"
            ],
            "intermediate": [
                ...
                "How do you handle application security in your projects?"
            ],
            "advanced": [
                ...
                "What's your approach to cloud-native architecture?",
                "How do you evaluate trade-offs between cost, performance, and reliability?"
            ]
        },
        "behavioral": {
            "beginner": [
            ...
            "intermediate": [
                ...
                "Tell me about a time when you dealt with a difficult teammate.",
                "How do you ensure effective communication in remote or hybrid teams?"
            ],
            "advanced": [
          ...
          "problem_solving": {
              "beginner": [
               ...
               "Can you give an example of a bug you fixed and how you approached it?",
               "How do you break down a big problem into smaller tasks?",
               "What's your strategy when you get stuck on a coding problem?"
          ],
          "intermediate": [
               "Describe a time when you had to debug a complex issue under time pressure.",
               "How do you approach optimizing a slow algorithm?",
               "Explain a time you had to choose between multiple possible solutions.",
               "What's your process for troubleshooting production issues?",
               "How do you validate whether your solution is correct and efficient?"
          ],
          "advanced": [
               "How do you approach solving problems in distributed systems?",
               "Explain a situation where you had to balance performance and correctness.",
               "What's your process for solving open-ended system design problems?",
               "How do you deal with ambiguity when defining a problem?",
               "How do you approach problems where there's no single 'right' answer?"
          ]
          }
        }
